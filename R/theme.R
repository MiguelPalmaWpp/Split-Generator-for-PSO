...
# Título del centro — ya NO usa position:absolute
# Es un nav_item normal que se inserta con nav_spacer() a ambos lados
app_center <- tags$div(
  style = paste0(
    "text-align:center; pointer-events:none;",
    "padding: 0 12px; white-space:nowrap;"
  ),
  tags$span("Split Generation for PSO",
            class = "app-main-title"),
  tags$br(),
  tags$span("By Advanced Analytics Colombia",
            class = "app-subtitle")
)
...
setTimeout(function() {
  ...
  $('.page-item.active .page-link')
    .css({'background-color':blue,'border-color':blue,'color':'white'});
...
/* ══════════════════════════════════════════════════════════
 NAVBAR — sin position:absolute, usa flex nativo
══════════════════════════════════════════════════════════ */
.navbar {
min-height: 62px;
padding: 0 20px;
...
/* Flex nativo de Bootstrap — NO position relative */
}
.navbar-brand {
padding: 0;
margin-right: 16px;
...
/* Título centrado — NO usa position:absolute
 Vive como nav_item entre dos nav_spacer()
 Solo ocupa el espacio disponible y se oculta si no hay */
.app-main-title {
color: white;
font-size: 15px;
font-weight: 700;
...
/* ══════════════════════════════════════════════════════════
 RESPONSIVE — oculta elementos según ancho disponible
 Sin position:absolute no puede haber solapamiento
══════════════════════════════════════════════════════════ */

/* Muy pequeño (<900px): iconos y badges desaparecen */
...
/* Pequeño (900–1200px): oculta logo derecho */
...
/* Medio (1200–1500px): logo derecho visible, tab badges ocultos */
...
.navbar-logo-right { height: 68px; }
.app-main-title    { font-size: 17px; }
...
background-color: #4a87c0 !important; border-color: #4a87c0 !important;
}
.btn-success {
background-color: #5B9BD5 !important;
border-color: #5B9BD5 !important; color: white !important;
...
font-size: 13px !important; color: #2c3e50 !important; padding: 7px 10px !important;
}
...
.selectize-dropdown {
border-color: #dde5ef !important; border-radius: 5px !important; font-size: 13px !important;
}
...
border: 1.5px solid #5B9BD5 !important; cursor: pointer !important;
font-size: 12px !important; font-weight: 500 !important;
background: white !important; color: #5B9BD5 !important;
margin: 0 !important; transition: all 0.15s !important; user-select: none;
}
...
color: #4a5568 !important; display: block !important; margin-bottom: 3px !important;
}
...
color: #4a87c0 !important; font-weight: 600; border-bottom-color: #5B9BD5 !important;
}
...
border-bottom: 2px solid #5B9BD5 !important; color: #2c3e50;
font-size: 13px; font-weight: 600; background-color: #fafcff; padding: 9px 12px;
}
...
border: 1px solid #dde5ef; border-radius: 5px; font-size: 13px; padding: 5px 10px;
}
.dataTables_filter input:focus {
border-color: #5B9BD5; box-shadow: 0 0 0 0.18rem rgba(91,155,213,0.22); outline: none;
}
.dataTables_length select {
border: 1px solid #dde5ef; border-radius: 5px; font-size: 13px; padding: 4px 8px;
}
...
.dt-button {
background: white !important; border: 1px solid #5B9BD5 !important;
color: #5B9BD5 !important; border-radius: 4px !important;
font-size: 12px !important; font-weight: 500 !important;
padding: 4px 12px !important; box-shadow: none !important;
transition: all 0.15s !important; cursor: pointer !important;
}
.dt-button:hover {
background: #EBF3FB !important; border-color: #4a87c0 !important;
color: #4a87c0 !important; box-shadow: none !important;
}
...
background-color: #5B9BD5 !important; border-color: #5B9BD5 !important;
}
...
.alert-success { background: #EBF3FB; color: #1565c0; }
.alert-info    { background: #EBF3FB; color: #4a87c0; }

/* ══════════════════════════════════════════════════════════
 SORTABLE BUCKET LIST — chips horizontales
══════════════════════════════════════════════════════════ */
.bucket-list-container { display: flex; gap: 12px; width: 100%; }
.rank-list-container {
border: 1px dashed #c8d6e5; border-radius: 6px;
padding: 8px; min-height: 44px; background: #fafcff; flex: 1;
display: flex !important; flex-wrap: wrap !important;
flex-direction: row !important; gap: 5px !important; align-content: flex-start;
}
.rank-list-item {
background: white; border: 1px solid #dde5ef; border-radius: 20px;
padding: 3px 11px; margin-bottom: 0 !important; cursor: grab;
...
background: #EBF3FB; border-color: #5B9BD5; color: #2c3e50; font-weight: 500;
}
